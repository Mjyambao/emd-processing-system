  ...
  const arrowBySide =
    {
      ...
      bottom:
        "bottom-full left-1/2 -translate-x-1/2 border-b-black/0 border-r-black/0 border-l-black/0 border-t-black/10",
      left: "left-full top-1/2 -translate-y-1/2 border-l-black/0 border-t-black/0 border-b-black/0 border-r-black/10",
      right:
        "right-full top-1/2 -translate-y-1/2 border-r-black/0 border-t-black/0 border-b-black/0 border-l-black/10",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          aria-hidden="true"
          className={["absolute h-0 w-0 border-8", arrowBySide].join(" ")}
        />
      </span>
    </span>
  );
