          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              <Field
                ...
                v={details.contactEmail || "—"}
              />
              <Field
                k={
                  <>
                    <i className="fa-solid fa-phone text-black/60"></i> Phone
                  </>
                }
                v={details.contactPhone || "—"}
              />
            </div>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              <Field
                k={
                  <>
                    <i className="fa-solid fa-suitcase-rolling text-black/60"></i>{" "}
                    EMD Desc
                  </>
                }
                v={details.emdDesc || "—"}
                          ...
                          content={
                            <>
                              <span className="block text-md">
                                {
                                  'Other info "unassisted minor international" maps to Qantas airline emd-s code.'
                                }
                              </span>
                              <span className="block text-md">
                                {"Retrieved from article from Sabre Central : "}
                                <a
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1">
                    ...
                    {isHuman && edit.rfisc ? (
                      <input
                        className="input mt-1 font-medium w-full p-0"
                        value={codes.rfisc}
                        onChange={(e) =>
            ...
            {isHuman ? (
              <div className="flex w-full justify-center">
                <button
                  ...
                  title="Refresh all EMDs & statuses"
                >
